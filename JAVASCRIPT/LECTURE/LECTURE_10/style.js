...
// let NewDate = new Date('3 april 2024 2:49:49 GMT');
// console.log(NewDate);
...
let Dates1 = Dates.setDate(15);

console.log(Dates1);

console.log(Dates);

let Dates2 = Dates.setFullYear(2004);

console.log(Dates);

let Dates3 = Dates.setHours(50);

console.log(Dates);

let Dates4 = Dates.setMinutes(40);

console.log(Dates);

let Dates5 = Dates.setSeconds(15);
